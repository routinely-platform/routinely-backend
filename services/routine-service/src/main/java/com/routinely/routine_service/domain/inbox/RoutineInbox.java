...
public class RoutineInbox {
    ...
    public static RoutineInbox received(String messageId, String eventType, String payload,
                                        String aggregateType, Long aggregateId) {
        RoutineInbox inbox = new RoutineInbox();
