...
class UserServiceExceptionHandlerTest {
    ...
    void handleNicknameCooldown_returnsConflictWithPayload() {
        ...
        ResponseEntity<ApiResponse<NicknameCooldownData>> response = handler.handleNicknameCooldown(exception);
        ...
        assertThat(response.getBody().getData()).isEqualTo(new NicknameCooldownData(20, nicknameChangeableAt));
    }
}
